...
class FinalWin(QWidget):
    def __init__(self, exp):
        ''' Jendela tempat survei sedang dilakukan '''
        super().__init__()

        # mengambil data tentang eksperimen
        self.exp = exp

        # membuat dan mengonfigurasi elemen grafis:
        self.initUI()

        # membangun koneksi antar elemen
        # self.connects()

        # mengatur tampilan jendela (label, ukuran, lokasi)
        self.set_appear()
